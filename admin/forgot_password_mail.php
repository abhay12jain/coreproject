...
//GET THE ALL FIELDS VALUES FROM DATABASE TABLE AND STORE THEM IN A VARIABLE TO UPDATE
  ...
  $varWhere = ' 1 AND pkEmailTemplateID =\'4\' AND EmailTemplateStatus=\'Active\'';
...
<legend> Forgot Password Mail Content</legend>
...
<input type="hidden" name="type" value="forgot_password_mail" />
...
<p>Here Admin Can Set Category Setting. Manage Categoryies (Add / Edit / Delete)</p>
